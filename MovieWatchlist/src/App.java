...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String sql = "INSERT INTO movie_watchlist (slno,movie_name,genere,rating,status) VALUES (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            sql ="update movie_watchlist set movie_name=?,genere=?,rating=?,status=? where slno=?";
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection(url, user, pass);
                PreparedStatement ps = con.prepareStatement(sql);
            ...
            sql ="select * from movie_watchlist";
            try {
                Connection con = DriverManager.getConnection(url, user, pass);
            ...
            sql ="delete from movie_watchlist where slno=?";
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection(url, user, pass);
                PreparedStatement ps = con.prepareStatement(sql);
